...
public class RightColumnOptions {
	...
	private WebElement rightSideForgottenPassswordOption;
	...
	public ForgottenPasswordPage clickOnRightSideForgottenPassswordOption() {
		rightSideForgottenPassswordOption.click();
